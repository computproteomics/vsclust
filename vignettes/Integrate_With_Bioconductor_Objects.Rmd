---
title: "VSClust run on MultiAssayExperiment"
...
You will need the library `MultiAssayExperiment` for loading the example data 
file.
...
# name of study
Experiment <- "miniACC" 
# Paired or unpaired statistical tests when carrying out LIMMA for statistical
# testing
isPaired <- FALSE
...
statOut <- PrepareSEForVSClust(miniACC2, "log2rnaseq", coldatname = "OncoSign", 
